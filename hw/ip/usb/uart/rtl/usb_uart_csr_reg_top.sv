...
#(
  ...
  rdl_subreg #(
    ...
    .we  (ctrl_we),
    .wd  (ctrl_tx_flush_wd),
    .de  (hw2reg.ctrl.tx_flush.de),
    .d   (hw2reg.ctrl.tx_flush.d),
    .qs  (ctrl_tx_flush_qs),
    .qe  (),
    .qre (),
  ...
  rdl_subreg #(
    ...
    .we  (ctrl_we),
    .wd  (ctrl_rx_flush_wd),
    .de  (hw2reg.ctrl.rx_flush.de),
    .d   (hw2reg.ctrl.rx_flush.d),
    .qs  (ctrl_rx_flush_qs),
    .qe  (),
    .qre (),
  ...
  rdl_subreg #(
    ...
    .we  (ctrl_we),
    .wd  (ctrl_tx_clear_wd),
    .de  (hw2reg.ctrl.tx_clear.de),
    .d   (hw2reg.ctrl.tx_clear.d),
    .qs  (ctrl_tx_clear_qs),
    .qe  (),
    .qre (),
