...
# Common Makefile for serv_soc firmware
#
...
SERV_SOC_DIR ?= $(dir $(lastword $(MAKEFILE_LIST)))
LIB_DIR      := $(SERV_SOC_DIR)/lib
...
# Architecture flags - SERV is RV32I only (no compressed, no multiply)
...
LDFLAGS += -static
LDFLAGS += -T$(SERV_SOC_DIR)/link.ld
...
# Common sources
COMMON_SRCS := $(LIB_DIR)/serv_soc.c
COMMON_ASRCS := $(SERV_SOC_DIR)/crt0.S
